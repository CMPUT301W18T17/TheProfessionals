...
public class ElasticSearchController3 {
...
//TODO - all methods (not async should be placed in some other class at some point
    ...
    private TaskList getTaskList (String search){
        ...
        ElasticSearchController3.GetTasks getTasks = new ElasticSearchController3.GetTasks();
    ...
    public Task getTask(String taskid) {
        Task task= null;
        ElasticSearchController3.GetTask gettask = new ElasticSearchController3.GetTask();
    ...
    public void addTasks(Task task) {
        ElasticSearchController3.AddTask addtask = new ElasticSearchController3.AddTask();
        addtask.execute(task);

        //now that the id is set, we need to update it into the db
        //TODO RESEARCH BETTER WAY
        ElasticSearchController3.UpdateTask updateTask = new ElasticSearchController3.UpdateTask();
    ...
    public Profile getProfile(String username) {
        ...
        ElasticSearchController3.GetProfile getprofile = new ElasticSearchController3.GetProfile();
    ...
    public Boolean addProfile(Profile profile) {
        ...
        boolean result;
        ElasticSearchController3.AddProfile addProfile = new ElasticSearchController3.AddProfile();
