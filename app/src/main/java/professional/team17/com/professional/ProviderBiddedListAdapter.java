...
/**
 * Created by Zhipeng Zhang on 2018-03-04.
 */

public class ProviderBiddedListAdapter extends ArrayAdapter<Task> {

    public ProviderBiddedListAdapter(Activity context, TaskList taskArrayList) {
